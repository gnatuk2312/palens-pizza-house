...
const FilledCart = ({ order }) => {
	...
	const { amount, modalOpen } = useSelector(state => {
		return state.cart;
	});
	...
	return (
		<>
					...
					<div className="cart">
						<div className="cart__top">
							<h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								Корзина</h2>
							<button onClick={clearAllCart} className="cart__clear">
						...
						<div className="cart__bottom">
							...
							<div className="cart__bottom-buttons">
								...
								<button onClick={handleOpenModal} className="button pay-btn">
									<span>Замовити</span>
								</button>
							</div>
						</div>
			...
			{modalOpen && <MakeOrder total={bill} />}
		</>
	);
};
